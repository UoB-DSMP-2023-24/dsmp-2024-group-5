    ...
    for e in range(epochs):
        ...
        if args.test_file != 'None':
            with torch.no_grad():
                ...
                y_pres = np.clip(y_pres, 0, 1)
                # print(y_pres)
                test_auc = brier_score_loss(y_trues,y_pres)            
                print('Epoch: ',e)
                print('Test brier_score_loss: ',brier_score_loss(y_trues,y_pres))
                record_aucs.append(brier_score_loss(y_trues,y_pres))
